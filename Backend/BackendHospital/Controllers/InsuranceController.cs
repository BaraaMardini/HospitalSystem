...
// =====================================================================
// InsuranceController
// Insurance.View=4194304 / Create=8388608 / Edit=16777216 / Delete=33554432  (index=1)
// =====================================================================
...
public class InsuranceController : ControllerBase
{
    ...
    [HasPermission(8388608, 0)]
    [Audit("CreateInsurance")]
    ...
    [HasPermission(16777216, 0)]
    [Audit("UpdateInsurance")]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]
    ...
    [HasPermission(33554432, 0)]
    [Audit("DeleteInsurance")]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]
    ...
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]
    [HttpGet("SearchInsurance")]
    public async Task<ActionResult> SearchInsurance(
       [FromQuery] SearchInsuranceRequest request,
        CancellationToken cancellationToken)
    {
        var result = await InsuranceService.SearchInsurance(
            request.CompanyName, request.CoveragePercentage, request.DefaultDurationMonths,
            cancellationToken);
        return ApiResponseHelper.GenerateApiResponse(this, result.ErrorType, result);
    }
