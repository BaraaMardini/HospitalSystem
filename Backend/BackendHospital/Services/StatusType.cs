    ...
    CancellationToken cancellationToken = default)
{
    ...
    return await StatusTypeData.UpdateStatusTypeByIDAsync(dto, cancellationToken);
}
    ...
    CancellationToken cancellationToken = default)
{
    ...
    return await StatusTypeData.DeleteStatusTypeByIDAsync(
        ID,
        cancellationToken);
}
    ...
    CancellationToken cancellationToken = default)
{
    ...
    return await StatusTypeData.GetStatusTypeByIDAsync(
        ID,
        cancellationToken);
}
